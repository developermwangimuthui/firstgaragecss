...
if(!isset($_SESSION['objMech']) || empty($_SESSION['objMech'])){
...
if(!empty($_SESSION['objMech']['image'])){
	$user_image = WEB_URL.'img/employee/'.$_SESSION['objMech']['image'];
}
?>
<!DOCTYPE html>
<html>
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo $user_image; ?>" class="user-image" alt="User Image"> <span class="hidden-xs"><?php echo !empty($_SESSION['objMech']['name']) ? $_SESSION['objMech']['name'] : ''; ?></span> </a>
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left"> <a href="<?php echo WEB_URL; ?>mech_panel/profile.php" class="btn btn-success btn-flat"><b>Profile</b></a> </div>
...
<aside class="main-sidebar">
  ...
  <div class="user-panel admin_header_border">
      ...
      <div class="pull-left info">
        ...
        <a href="<?php echo WEB_URL; ?>cust_panel/profile.php"><i class="fa fa-circle text-success"></i> Online</a> </div>
    </div>
  <section class="sidebar" style="margin-top:10px;">
    <!-- sidebar menu: : style can be found in sidebar.less -->
    <ul class="sidebar-menu">
      <li class="header">MAIN NAVIGATION</li>
	  <li class="<?php if($page_name != '' && $page_name == 'mech_dashboard'){echo 'active';}?> tm10"><a href="<?php echo WEB_URL; ?>mech_panel/mech_dashboard.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a> </li>
      <li class="treeview <?php if($page_name != '' && $page_name == 'workstatus' || $page_name == 'addworkstatus'){echo 'active';}?>"> <a href="<?php echo WEB_URL; ?>mech_panel/workstatus.php"> <i class="fa fa-wrench"></i> <span>Daily Work</span></a></li>
	  <li class="treeview <?php if($page_name != '' && $page_name == 'rptmsalary'){echo 'active';}?>"> <a href="<?php echo WEB_URL; ?>mech_panel/rptmsalary.php"> <i class="fa fa-money"></i> <span>Salary Status</span></a></li>
	  <li class="treeview <?php if($page_name != '' && $page_name == 'pagebuilder'){echo 'active';}?>"> <a href="<?php echo WEB_URL; ?>mech_panel/pagebuilder.php"> <i class="fa fa-file-powerpoint-o"></i> <span>Profile Page</span></a></li>  
      </li>
    </ul>
  </section>
  <!-- /.sidebar -->
