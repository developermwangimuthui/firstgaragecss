...
if(isset($_GET['delid']) && $_GET['delid'] != '' && $_GET['delid'] > 0){
	$wms->deleteNewsComments($link, $_GET['delid']); 
	$delinfo = 'block';
}
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div id="you" class="alert alert-success alert-dismissable" style="display:<?php echo $addinfo; ?>">
      ...
      <?php echo $msg; ?> </div>
    <div align="right" style="margin-bottom:1%;"> <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>cms/addnewscomments.php" data-original-title="Add Testimonials"><i class="fa fa-plus"></i></a> <a class="btn btn-warning" data-toggle="tooltip" href="<?php echo WEB_URL; ?>dashboard.php" data-original-title="Dashboard"><i class="fa fa-dashboard"></i></a> </div>
    <div class="box box-success">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        <?php
			$results = $wms->getAllNewsCommentsList($link);
...
<script type="text/javascript">
	function deleteComments(Id){
		...
		if(iAnswer){
			window.location = '<?php echo WEB_URL; ?>cms/newscommentslist.php?delid=' + Id;
		}
  	}
