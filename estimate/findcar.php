...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Find Car Estimate</li>
  </ol>
</section>
<!-- Main content -->
...
<div class="row">
      ...
      <div class="box box-success" id="box_model">
        <div class="box-body">
          ...
          <div class="form-group col-md-12">
            <label for="txtInvoiceNo">Repair CAR ID :</label>
  ...
  aria-valuemin="0" aria-valuemax="100" style="width:<?php //echo $row['work_status']; ?>%"></div>
            ...
            <div class="form-group text-right"><a href="<?php echo WEB_URL; ?>estimate/estimate_form.php?carid=<?php echo $row['car_id']; ?>&customer_id=<?php echo $row['customer_id']; ?>" style="font-weight:bold;font-size:17px;" class="btn btn-danger"><i class="fa fa-plus"></i> Add New Estimate</a></div>
            <div class="form-group text-right"><a data-toggle="tooltip" href="javascript:;" onClick="$('#estimate_view_<?php echo $row['car_id']; ?>').modal('show');" data-original-title="All Estimate History" style="font-weight:bold;font-size:17px;" class="btn btn-primary"><i class="fa fa-calendar-check-o"></i> Added Estimate List</a></div>
          </div>
