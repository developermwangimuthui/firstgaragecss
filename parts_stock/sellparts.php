...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Sell New/Old Parts</li>
    <li class="active">Sell New/Old Parts</li>
  </ol>
</section>
<!-- Main content -->
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="box box-success" id="box_model">
        <div class="box-body">
          <div class="box-header">
            <h3 class="box-title"><i class="fa fa-search"></i> Find Your Parts</h3>
          </div>
          ...
          <div class="form-group col-md-4">
		  	<label for="txtCondition">Part No. :</label>
    ...
    <div class="box box-success" id="box_model">
      <div class="box-body">
        <div class="box-header">
          <h3 class="box-title"><i class="fa fa-list"></i> Available Parts List</h3>
        </div>
        <?php 
        ...
        <div style="width:98%;height:auto;border:solid 1px #ccc;padding:10px;margin:10px;">
          ...
          <div class="col-md-3 text-left">
            ...
            <div><b>Quantity:</b> <span class="label label-danger" style="font-size:11px;"><?php echo $row['quantity']; ?></span></div>
            <div><b>Part No:</b> <?php echo $row['part_no']; ?></div>
			<div><b>Manufacturer:</b> <?php echo $row['manufacturer_name']; ?></div>
          ...
          <div class="col-md-3 text-left">
            ...
            <div><b>Supplier Name:</b> <?php echo $row['s_name']; ?></div>
            <div><b>Parts Warranty:</b> <span class="label label-warning"><?php echo !empty($row['parts_warranty']) ? $row['parts_warranty'] : 'No'; ?></span></div>
          </div>
        ...
        <div align="center">No parts found based on your selected query.</div>
        <?php } ?>
      </div>
    </div>
  </div>
...
<div id="minicart" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"> <b>Your item added successfully.</b> <br/>
