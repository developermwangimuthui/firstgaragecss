  ...
  <div class="invoice-wrap">
    <div class="invoice-inner">
	  ...
	  <div id="items-list">
		...
		<table class="table">
			<tr>
				<td><div style="border-bottom:solid 1px #000;width:200px;"><b>Supplier Name :</b>&emsp;<?php echo $row['supplier_name']; ?></div></td>
				<td><div style="border-bottom:solid 1px #000;width:200px;margin-left:32px;"><b>Manufacturer :</b>&emsp;<?php echo $row['manufacturer_name']; ?></div></td>
				<td><div style="border-bottom:solid 1px #000;width:200px;margin-left:32px;text-transform:capitalize;"><b>Condition :</b>&emsp;<?php echo $row['parts_condition']; ?></div></td>
			</tr>
			<tr>
				<td style="padding-top:10px;"><div style="border-bottom:solid 1px #000;width:200px;"><b>Model No. :</b>&emsp;<?php echo $row['parts_sku']; ?></div></td>
			</tr>
		</table>
      </div>
	  <br/>
        ...
        <table class="table table-bordered table-condensed table-striped items-table">
          ...
          <tfoot>
            <tr class="totals-row">
              ...
              <td coslpan="3"><?php echo $currency; ?><?php echo $row['total_amount']; ?></td>
            </tr>
            <tr class="totals-row">
              <td colspan="3" class="wide-cell"></td>
              <td><strong>Paid Amount </strong></td>
              <td coslpan="3"><?php echo $currency; ?><?php echo $row['given_amount']; ?></td>
            </tr>
            <tr class="totals-row">
              <td colspan="3" class="wide-cell"></td>
              <td><strong>Balance Due </strong></td>
              <td coslpan="3"><?php echo $currency; ?><?php echo $row['pending_amount']; ?></td>
            </tr>
          </tfoot>
          <tbody>
			<tr>
			  <td><?php echo $row['parts_name']; ?></td>
			  <td><?php echo $row['parts_warranty']; ?></td>
			  <td><?php echo $currency; ?><?php echo $row['parts_buy_price']; ?></td>
			  <td><?php echo $row['parts_quantity']; ?></td>
