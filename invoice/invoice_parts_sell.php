<?php include('../helper/common.php');include_once('../config.php'); include_once('../dbconfig.php'); if(isset($_GET['invoice_id']) && !empty($_GET['invoice_id'])) { ?>
<?php
$site_name = '';
$currency = '';
$email = '';
...
$row = $wms->getSellPartsInformationByInvoiceId($link, $_GET['invoice_id']);
      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody>
          <tr>
            ...
            <td valign="top" align="right"><p class="editable-text" id="extra">Sell Invoice</p></td>
          </tr>
        </tbody>
      </table>
                    ...
                    <tr>
                      ...
                      <td valign="top"><div class="client_info">
                          <table cellspacing="0" cellpadding="0" border="0">
                            <tbody>
                              <tr>
                                <td style="padding-left:25px;"><span class="editable-area" id="client_info"><?php echo $row['invoice']['customer_name']; ?><br>
                                  <div style="white-space: pre-wrap;"><?php echo $row['invoice']['delivery_address']; ?></div>
                                  </span></td>
                              </tr>
                            </tbody>
                          </table>
              ...
              <td width="50%" valign="top" align="right"><table cellspacing="0" cellpadding="0" border="0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="padding-left:20px" align="left"><span class="editable-text" id="date"><?php echo $wms->mySqlToDatePicker($row['invoice']['invoice_date']); ?></span></td>
                    </tr>
                    <!-- Fieldl-->
                    <tr class="field1_row">
        ...
        <table class="table table-bordered table-condensed table-striped items-table">
          ...
          <tfoot>
            <tr class="totals-row">
              ...
              <td coslpan="4"><?php echo $currency; ?><?php echo $row['total']; ?></td>
            </tr>
            <tr class="totals-row">
              <td colspan="4" class="wide-cell"></td>
              <td><strong>Discount</strong></td>
              <td coslpan="4"><?php echo $row['invoice']['discount']; ?>%</td>
            </tr>
			<tr class="totals-row">
              <td colspan="4" class="wide-cell"></td>
              <td><strong>Grand Total</strong></td>
              <td coslpan="4"><?php echo $currency; ?><?php echo $row['invoice']['grand_total']; ?></td>
            </tr>
            <tr class="totals-row">
              <td colspan="4" class="wide-cell"></td>
              <td><strong>Paid Amount </strong></td>
              <td coslpan="4"><?php echo $currency; ?><?php echo $row['invoice']['paid_amount']; ?></td>
            </tr>
            <tr class="totals-row">
              <td colspan="4" class="wide-cell"></td>
              <td><strong>Balance Due </strong></td>
              <td coslpan="4"><?php echo $currency; ?><?php echo $row['invoice']['due_amount']; ?></td>
            </tr>
          </tfoot>
          <tbody>
            <?php if(!empty($row['parts'])) { ?>
				<?php foreach($row['parts'] as $parts) { ?>
				<tr>
				  <td><?php echo $parts['parts_name']; ?></td>
				  <td><?php echo $parts['parts_warranty']; ?></td>
				  <td style="text-transform:capitalize;"><?php echo $parts['parts_condition']; ?></td>
				  <td><?php echo $currency; ?><?php echo number_format($parts['parts_price'],2); ?></td>
				  <td><?php echo $parts['quantity']; ?></td>
				  <td><?php echo $currency; ?><?php echo $parts['total']; ?></td>
				</tr>
				<?php } ?>
			<?php } ?>
          </tbody>
...
<div id="mobile-preview-close"><a style="" href="javascript:window.print();"><img src="<?php echo WEB_URL; ?>img/print.png" style="float:left; margin:0 10px 0 0;"> Print </a> <a style="" href="<?php echo WEB_URL; ?>parts_stock/sellpartslist.php"><img src="<?php echo WEB_URL; ?>img/back.png" style="float:left; margin:0 10px 0 0;"> Back </a> </div>
</body>
</html>
<?php } else { ?>
