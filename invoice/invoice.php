<?php include('../helper/common.php'); include_once('../dbconfig.php');include_once('../config.php'); if(isset($_GET['invoice_id']) && !empty($_GET['invoice_id'])) { ?>
<?php
$site_name = '';
$currency = '';
$email = '';
...
$row = $wms->getEstimateAndCarAndCustomerDetails($link,$_GET['invoice_id']);
...
.totals-row .wide-cell { border:1px solid #fff; border-right:1px solid #555555; border-top:1px solid #555555}
  ...
  <div class="invoice-wrap">
    <div class="invoice-inner">
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody>
          <tr>
            ...
            <td valign="top" align="right"><p class="editable-text" id="extra">Repair Invoice</p></td>
          </tr>
        </tbody>
      </table>
                    ...
                    <tr>
                      ...
                      <td valign="top"><div class="client_info">
                          <table cellspacing="0" cellpadding="0" border="0">
                            <tbody>
                              <tr>
                                <td style="padding-left:25px;"><span class="editable-area" id="client_info"><?php echo $row['c_name']; ?><br>
                                  <div style="white-space: pre-wrap;"><?php echo $row['c_address']; ?></div>
                                  </span></td>
                              </tr>
                            </tbody>
                          </table>
              ...
              <td width="50%" valign="top" align="right"><table cellspacing="0" cellpadding="0" border="0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="padding-left:20px" align="left"><span class="editable-text" id="date"><?php echo $wms->mySqlToDatePicker($row['delivery_done_date']); ?></span></td>
                    </tr>
                    <!-- Fieldl-->
                    <tr class="field1_row">
	  ...
	  <br/>
      <div id="items-list">
        <div style="font-weight:bold;font-size:12px;border-bottom:solid 1px #000;margin-bottom:10px;">Car Information</div>
		<table class="table">
			<tr>
				<td><div style="border-bottom:solid 1px #000;width:200px;"><b>Car Name</b>&emsp;<?php echo $row['car_name']; ?></div></td>
				<td><div style="border-bottom:solid 1px #000;width:200px;margin-left:32px;"><b>Make</b>&emsp;<?php echo $row['make_name']; ?></div></td>
				<td><div style="border-bottom:solid 1px #000;width:200px;margin-left:32px;"><b>Model</b>&emsp;<?php echo $row['model_name']; ?></div></td>
			</tr>
			<tr>
				<td style="padding-top:10px;"><div style="border-bottom:solid 1px #000;width:200px;"><b>Year</b>&emsp;<?php echo $row['year_name']; ?></div></td>
				<td style="padding-top:10px;"><div style="border-bottom:solid 1px #000;width:200px;margin-left:32px;"><b>Chasis No</b>&emsp;<?php echo $row['chasis_no']; ?></div></td>
				<td style="padding-top:10px;"><div style="border-bottom:solid 1px #000;width:200px;margin-left:32px;"><b>Reg No</b>&emsp;<?php echo $row['car_reg_no']; ?></div></td>
			</tr>
		</table>
      </div>
	  <br/>
        ...
        <table class="table table-bordered table-condensed table-striped items-table">
          ...
          <tfoot>
            <tr class="totals-row">
              ...
              <td coslpan="4"><?php echo $currency; ?><?php echo $row['total_cost']; ?></td>
            </tr>
            <tr class="totals-row">
              <td colspan="4" class="wide-cell"></td>
              <td><strong>Discount</strong></td>
              <td coslpan="4"><?php echo $row['discount']; ?>%</td>
            </tr>
            <tr class="totals-row">
              <td colspan="4" class="wide-cell"></td>
              <td><strong>Paid Amount </strong></td>
              <td coslpan="4"><?php echo $currency; ?><?php echo $row['payment_done']; ?></td>
            </tr>
            <tr class="totals-row">
              <td colspan="4" class="wide-cell"></td>
              <td><strong>Balance Due </strong></td>
              <td coslpan="4"><?php echo $currency; ?><?php echo $row['payment_due']; ?></td>
            </tr>
          </tfoot>
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $currency; ?>
                <?php if(!empty($estimate->price)){echo $estimate->price; } ?></td>
              <td><?php if(!empty($estimate->quantity)){echo $estimate->quantity; } ?></td>
              <td><?php echo $currency; ?>
                <?php if(!empty($estimate->labour)){echo $estimate->labour; } ?></td>
			  <td><?php if(!empty($estimate->warranty)){echo str_replace("-"," ",$estimate->warranty); } ?></td>
              <td><?php echo $currency; ?>
                <?php if(!empty($estimate->total)){echo $estimate->total; } ?></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
      ...
      <div class="notes-block">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tbody>
            <tr>
              <td><div class="editable-area" id="notes" style="font-style:italic;border-top:solid 1px #000;width:150px;text-align:center;">Customer Signature</div></td>
            </tr>
          </tbody>
        </table>
      </div>
