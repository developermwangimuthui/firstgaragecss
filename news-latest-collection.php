...
$result = $wms->getAllNewsCollections($link);
?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"> News Collection</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="row news_details">
        <div class="col-md-9 pr-50">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 cp-bottom-mobile-space mb-20">
              <div class="latest-single">
                <div class="ltst-img"> <img style="width:425px" src="<?php echo $newx['thumb_image']?>" alt=""> </div>
            ...
            <?php } ?>
            <?php } else  { ?>
            <div class="alert alert-success not_found_news"><i class="fa fa-info-circle"></i> No news found for this.</div>
            <?php } ?>
          </div>
        </div>
